...
const CallToAction = () => {
    return (
        <div className="">
            <div className="w-full bg-gray-500 bg-[url('https://source.unsplash.com/random/640x480')] bg-cover bg-center bg-blend-multiply bg-no-repeat"
            ...
            >
                <div className="container flex flex-col flex-wrap content-center justify-center p-4 py-20 mx-auto md:p-10">
                    ...
                    <div className="flex flex-row">
                        ...
                        <button type="button" className="w-2/5 p-3 font-semibold rounded-r-lg sm:w-1/3 bg-amber-600 text-gray-50">Subscribe</button>
                    </div>
                </div>
            </div>
        </div>
