...
const UpdateVolunteerPost = () => {
    ...
    useEffect(() => {
        document.title = 'Update Volunteer Post';
    }, []);
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const { data } = await axios.put(`${import.meta.env.VITE_API_URL}/update-post/${_id}`, PostData, {
    ...
    return (
        <div className='container max-w-5xl mx-auto bg-white dark:bg-slate-800 rounded-lg px-6 py-8 my-10 ring-1 ring-slate-900/5 shadow-xl'>
            <div className="border-b border-gray-900/10 pb-12 dark:text-white">
                <h2 className="text-base font-semibold leading-7 text-gray-500 text-center">Upate Volunteer Post</h2>
